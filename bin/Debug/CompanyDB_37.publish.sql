...
GO
ALTER TABLE [dbo].[AddressToEmployee] DROP CONSTRAINT [DF__AddressTo__Creat__02FC7413];
...
GO
ALTER TABLE [dbo].[AddressToEmployee] DROP CONSTRAINT [FK__AddressTo__Addre__03F0984C];
...
GO
ALTER TABLE [dbo].[AddressToEmployee] DROP CONSTRAINT [FK__AddressTo__Emplo__74AE54BC];
